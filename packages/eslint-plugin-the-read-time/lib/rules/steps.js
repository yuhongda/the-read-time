...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      category: 'Fill me in',
      recommended: false,
      url: `https://github.com/yuhongda/the-read-time/blob/main/packages/eslint-plugin-the-read-time/docs/rules/steps.md` // URL to the documentation page for this rule
    },
